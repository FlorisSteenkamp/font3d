 ...
 */
function invert(a: Mat4): Mat4 | undefined {
    const a00 = a[0];
    const a01 = a[1];
    const a02 = a[2];
    const a03 = a[3];
...
function rotate(
        a: Mat4,
        rad: number,
        axis: [number,number,number]): Mat4 {
...
export {
    createUnitMat4, invert, ortho, perspective, translate, rotate,
    transpose
}
